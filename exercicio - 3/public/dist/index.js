...
// Mova a declaração da variável 'users' para fora das interfaces
const users = [];
...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        yield fetchUser('GabrielGeraldo99');
        yield fetchUser('octocat');
        yield fetchUser('mojombo');
        yield fetchUser('defunkt');
        yield fetchUser('pjhyett');
        yield fetchUser('tivie');
        yield showUser('GabrielGeraldo99');
        yield showUser('octocat');
        showAllUsers();
        showReposTotal();
        showTopFive();
    });
