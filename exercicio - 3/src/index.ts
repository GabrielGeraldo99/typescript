...
async function main() {
  await fetchUser('GabrielGeraldo99') 
  await fetchUser('octocat') 
  await fetchUser('mojombo') 
  await fetchUser('defunkt') 
  await fetchUser('pjhyett') 
  await fetchUser('tivie') 

  await showUser('GabrielGeraldo99')
  await showUser('octocat')
